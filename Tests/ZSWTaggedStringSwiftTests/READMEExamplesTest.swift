...
//}
//
//class READMEExamplesSpec: QuickSpec {
//	override func spec() {
...
//											story.type.rawValue, ZSWEscapedString(for: story.name))
//			}
//			
...
//			options["story"] = .dynamic { _, tagAttributes, _ in
...
//			]
//			
//			options.unknownTagAttributes = .dynamic { tagName, _, existingAttributes in
